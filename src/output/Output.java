...
public class Output {
    ...
    private static void printMergedWithBubbleSortFromTheBeginningToSortedArray() {
        System.out.println("Merged sort with Bubble sort from the beginning to sorted array takes \t\t\t" + Analyzer.
                mergedWithBubbleSortFromTheBeginningToSortedArray() + " ns");
    }
    ...
    private static void printMergedWithBubbleSortFromTheEndToSortedArrayWithX() {
        System.out.println("Merged sort with Bubble sort from the end to sorted array with X takes \t\t\t" + Analyzer.
                mergedWithBubbleSortFromTheEndToSortedArrayWithX() + " ns");
    }
    ...
    private static void printMergedWithBubbleSortFromTheBeginningToSortedRevertedArray() {
        System.out.println("Merged sort with Bubble sort from the beginning to sorted reverted array takes \t" + Analyzer.
                mergedWithBubbleSortFromTheBeginningToSortedArray() + " ns");
    }
    ...
    private static void printMergedWithQuickSortToSortedRevertedArray() {
        System.out.println("Merged sort with Quick sort to sorted reverted array takes \t\t\t\t\t\t" + Analyzer.
                mergedWithQuickSortToSortedRevertedArray() + " ns");
    }

    private static void printMergedWithArraySortToSortedRevertedArray() {
        System.out.println("Merged sort with Array sort to sorted reverted array takes \t\t\t\t\t\t" + Analyzer.
                mergedWithArraySortToSortedRevertedArray() + " ns");
    }
    ...
    private static void printMergedWithBubbleSortFromTheBeginningToRandomlyFilledArray() {
        System.out.println("Merged sort with Bubble sort from the beginning to randomly filled array takes \t" + Analyzer.
                mergedWithBubbleSortFromTheBeginningToRandomlyFilledArray() + " ns");
    }
    ...
    private static void printMergedWithQuickSortToRandomlyFilledArray() {
        System.out.println("Merged sort with Quick sort to randomly filled array takes \t\t\t\t\t\t" + Analyzer.
                mergedWithQuickSortToRandomlyFilledArray() + " ns");
    }

    private static void printMergedWithArraySortToRandomlyFilledArray() {
        System.out.println("Merged sort with Array sort to randomly filled array takes \t\t\t\t\t\t" + Analyzer.
                mergedWithArraySortToRandomlyFilledArray() + " ns");
    }
    ...
    public static void main(String[] args) {
        ...
        printMergedWithBubbleSortFromTheBeginningToSortedArray();
        printMergedWithBubbleSortFromTheBeginningToSortedArrayWithX();
        printMergedWithBubbleSortFromTheBeginningToSortedRevertedArray();
        printMergedWithBubbleSortFromTheBeginningToRandomlyFilledArray();
        ...
        printMergedWithBubbleSortFromTheEndToSortedArray();
        printMergedWithBubbleSortFromTheEndToSortedArrayWithX();
        printMergedWithBubbleSortFromTheEndToSortedRevertedArray();
        printMergedWithBubbleSortFromTheEndToRandomlyFilledArray();
        ...
        printMergedWithQuickSortToSortedArray();
        printMergedWithQuickSortToSortedArrayWithX();
        ...
        printMergedWithArraySortToSortedArray();
        printMergedWithArraySortToSortedArrayWithX();
